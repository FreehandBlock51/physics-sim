...
/**
 * @brief A combination of a vertex array and an index array
 */
...
typedef struct IndexedVertexArray ivarray_t;

/**
 * @brief Creates an Indexed Vertex Array
 * @param initial_vertex_capacity The initial capacity of the vertex array
 * @param initial_index_capacity The initial capacity of the index array
...
/**
 * @brief Adds a vertex to the array
 * @param array The array to add to
 * @param vertex The vertex to add
 * @param vertex_size The number of values in this vertex
 * @return 0 on success, or -1 on failure
 */
int ivarray_add_vertex(ivarray_t *array, GLfloat *vertex, size_t vertex_size);

/**
 * @brief Adds multiple vertices to the array
 * @param array The array to add to
 * @param vertices The vertices to add
 * @param vertex_size The number of values in a single vertex
 * @param vertex_count The number of vertices to add
 * @return 0 on success, or -1 on failure
 */
int ivarray_add_vertices(ivarray_t *array, GLfloat *vertices, size_t vertex_size, size_t vertex_count);

/**
 * @brief Draws an array
 * @param mode The mode OpenGL will use to draw the array
 * @param array The array to draw
 */
